...
export async function manageSubscriptionAction(input) {
    ...
    const email =
        session?.user.email?.find(e => e.id === user.primaryEmailAddressId)
            ?.emailAddress ?? ""
...
export async function getStripeAccountAction(input) {
...
export async function createAccountLinkAction(input) {
...
export async function getPaymentIntentsAction(input) {
    try {
...
export async function getPaymentIntentAction(input) {
    try {
